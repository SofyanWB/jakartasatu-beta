...
const JenisKegiatan = ({ dataKegiatan, layerView, isHitung }) => {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center", textAlign: "center", height: isHitung ? "50%": "60%", borderRadius: 2, boxShadow: "0 2px 8px rgba(0,0,0,.3)" }}>
      ...
      <Box sx={{backgroundColor: "aqua", width: "auto", marginLeft: 2, marginRight: 2}}>
        <TextField size="small" sx={{ width: "100%" }} id="searchInput" onChange={searchKegiatan} placeholder="Cari Kegiatan ..."/>
      </Box>
